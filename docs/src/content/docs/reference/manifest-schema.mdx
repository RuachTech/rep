---
title: Manifest Schema — .rep.yaml File Format Reference
description: Complete reference for the .rep.yaml manifest. Variable declarations, supported types (string, url, number, boolean, csv, json, enum), defaults, required flags, and gateway settings.
---
