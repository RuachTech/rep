---
title: Svelte Adapter API — repStore() and repSecureStore()
description: API reference for @rep-protocol/svelte. repStore() creates a readable store for public variables with SSE hot reload. repSecureStore() for async encrypted variable access.
---
