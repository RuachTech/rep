---
title: React Adapter API — useRep() and useRepSecure() Hooks
description: API reference for @rep-protocol/react. useRep() for synchronous public variable access with hot reload re-rendering. useRepSecure() for encrypted variable decryption.
---
