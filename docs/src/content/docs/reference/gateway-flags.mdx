---
title: Gateway Flags and Environment Variables
description: All CLI flags and REP_GATEWAY_* environment variables for configuring the gateway. Port, mode, upstream, strict mode, hot reload, logging, CORS, and rate limiting options.
---
