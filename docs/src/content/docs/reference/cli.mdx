---
title: CLI Commands
description: Complete reference for the @rep-protocol/cli tool — validate, typegen, lint, dev.
---
...
**File-level skip:** Files with `.min.js` / `.min.mjs` / `.min.cjs` extensions are skipped entirely — these are third-party vendor bundles that don't contain your application code.
