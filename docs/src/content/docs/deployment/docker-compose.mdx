---
title: Docker Compose — Same Image, Different Config Per Environment
description: Run the same frontend Docker image across staging and production with Docker Compose. Different environment variables per service, .env file support, and dev proxy setup.
---
