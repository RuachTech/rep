---
title: Docker Embedded Mode — Minimal FROM scratch Containers
description: Deploy a frontend app in a minimal FROM scratch Docker container. The REP gateway serves static files directly — no nginx, no Node.js, no shell. Under 10MB total.
---
