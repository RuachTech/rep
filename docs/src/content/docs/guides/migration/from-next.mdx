---
title: Migrate from Next.js — Replace NEXT_PUBLIC_* with Runtime Config
description: Migrate from Next.js NEXT_PUBLIC_* build-time variables to REP runtime environment variables. Handles client-side code, SSR considerations, and automated codemod.
---
