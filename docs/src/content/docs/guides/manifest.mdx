---
title: Manifest File — .rep.yaml Configuration Reference
description: Declare environment variables, types, defaults, and validation rules in .rep.yaml. Generate TypeScript types and validate config at gateway startup.
---
