---
title: How REP Works — Gateway Architecture and HTML Injection
description: How the REP gateway injects environment variables into HTML at runtime. Proxy and embedded modes, startup sequence, script tag injection, and SDK initialization.
---
