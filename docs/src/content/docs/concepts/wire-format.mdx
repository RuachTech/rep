---
title: Wire Format — Payload JSON, Encryption, and HMAC Integrity
description: The REP payload wire format. JSON structure, AES-256-GCM encrypted blob, HKDF key derivation, HMAC-SHA256 integrity tokens, and SRI verification.
---
