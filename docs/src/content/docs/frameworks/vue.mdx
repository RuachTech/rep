---
title: Vue 3 Runtime Environment Variables — useRep() Composables
description: Access runtime environment variables in Vue 3 with useRep() and useRepSecure() composables. Reactive refs with automatic hot reload updates.
---
