---
title: Svelte Runtime Environment Variables — repStore()
description: Access runtime environment variables in Svelte with repStore() and repSecureStore(). Native readable stores with lazy SSE hot reload subscriptions.
---
