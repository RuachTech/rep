---
title: Angular Runtime Environment Variables — RepService
description: Access runtime environment variables in Angular with an injectable RepService. Observable support for reactive config updates without page reload.
---
