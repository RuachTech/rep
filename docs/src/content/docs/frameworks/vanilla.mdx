...
For a complete, runnable single-file app — SDK loaded from [esm.sh](https://esm.sh), no `npm install`, no build step — see the [Simple HTML example](/examples/simple-html/).
