---
title: Specification Overview — REP Protocol Documents
description: Formal specification documents for the Runtime Environment Protocol. RFC-0001 core protocol, security model threat analysis, and conformance requirements for implementations.
---
