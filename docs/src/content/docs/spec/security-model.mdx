---
title: Security Model Specification — Threat Model and Analysis
description: Formal threat model for the Runtime Environment Protocol. Seven threat analyses covering XSS, CDN compromise, session key theft, env var leaks, and more. Hardening recommendations.
---
