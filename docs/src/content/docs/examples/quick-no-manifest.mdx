---
title: Zero-Config Quick Start — No Manifest Required
description: Use REP with just naming conventions and no configuration file. Rename env vars with REP_PUBLIC_/REP_SENSITIVE_ prefixes, install the SDK, and run the gateway.
---
