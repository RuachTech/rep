...
function generateTypeDefinition(publicVars: string[], sensitiveVars: string[]): string {
  ...
  lines.push('');
  lines.push('    /**');
  lines.push('     * Retrieve all PUBLIC tier variables as a frozen object. Synchronous.');
  lines.push('     */');
  lines.push('    getAll(): Readonly<Record<string, string>>;');
  lines.push('');
  lines.push('    /**');
  lines.push('     * Subscribe to changes for a specific variable.');
  lines.push('     */');
  lines.push('    onChange(key: string, callback: (newValue: string, oldValue: string | undefined) => void): () => void;');
  lines.push('');
  lines.push('    /**');
  lines.push('     * Subscribe to any variable change.');
  lines.push('     */');
  lines.push('    onAnyChange(callback: (key: string, newValue: string, oldValue: string | undefined) => void): () => void;');
  lines.push('');
  lines.push('    /**');
  lines.push('     * Verify payload integrity. Synchronous.');
  lines.push('     */');
  lines.push('    verify(): boolean;');
  lines.push('');
  lines.push('    /**');
  ...
  lines.push('      injectedAt: Date;');
  lines.push('      integrityValid: boolean;');
  lines.push('      publicCount: number;');
  lines.push('      sensitiveAvailable: boolean;');
  lines.push('      hotReloadAvailable: boolean;');
  lines.push('    } | null;');
  lines.push('  }');
  lines.push('');
  ...
  lines.push('  export function verify(): boolean;');
